...
//EditItemCtrl--------------------------------------------------------------------------------------
//EditItemCtrl--------------------------------------------------------------------------------------
.controller('EditItemReportController', 
    ...
    $log.debug('EditItemReportCtrl:  configAction :' +  $state.current.configAction);
    $log.debug($state);
...
.controller('ListReportController', 
  ...
  $scope.tipiReportList = [
                             ...
                             "id" : 1,
                             "checked" :  true,
                             "text" : "Tipi segnalazione per mese"
                            },
                             {
                             "id" : 2,
                             "checked" :  true,
                             "text" : "Tipi segnalazione per anno"
                            }
                ];
  ...
  $scope.frmData.descReport = "Tipi segnalazione per mese";
